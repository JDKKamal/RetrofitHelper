...
public class APICall<T> {
    ...
    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, final int from) {
        APIRequest(type, url,responseModel,body, params, from, false,"", responseListener);
    }

    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, final int from, boolean isPDShow, String message) {
        APIRequest(type, url,responseModel,body, params, from, isPDShow,message, responseListener);
    }

    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, APIListener responseListener) {
        APIRequest(type, url, responseModel, body, params, 1,false,"", responseListener);
    }

    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, APIListener responseListener, boolean isPDShow, String message) {
        APIRequest(type, url, responseModel, body, params, 1,isPDShow,message, responseListener);
    }

    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, final int from, String message) {
        APIRequest(type, url, responseModel, body, params, from, true,message, responseListener);
    }

    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, String message, APIListener responseListener) {
        APIRequest(type, url,responseModel, body, params, 1, true, message, responseListener);
    }

    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, boolean isPDShow, String message, APIListener responseListener) {
        APIRequest(type, url,responseModel, body, params, 1, isPDShow, message, responseListener);
    }


    public void APIRequest(Method type, String url, final Class<T> responseModel, RequestBody body, Map<String, String> params, final int from, boolean is_PDshow, String message, final APIListener responseListener) {
        call = null;
        String TAG = "APICall";
